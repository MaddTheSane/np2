...
#define	BYTE_SARCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_BYTE_SARCL(d, s, c); \
	if ((_d != (UINT8)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("sarb(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	WORD_SARCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_WORD_SARCL(d, s, c); \
	if ((_d != (UINT16)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("sarw(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	DWORD_SARCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_DWORD_SARCL(d, s, c); \
	if ((_d != (UINT32)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("sard(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	BYTE_SHLCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_BYTE_SHLCL(d, s, c); \
	if ((_d != (UINT8)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("shlb(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	WORD_SHLCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_WORD_SHLCL(d, s, c); \
	if ((_d != (UINT16)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("shlw(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	DWORD_SHLCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_DWORD_SHLCL(d, s, c); \
	if ((_d != (UINT32)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("shld(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	BYTE_SHRCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_BYTE_SHRCL(d, s, c); \
	if ((_d != (UINT8)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("shrb(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	WORD_SHRCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_WORD_SHRCL(d, s, c); \
	if ((_d != (UINT16)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("shrw(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	DWORD_SHRCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_DWORD_SHRCL(d, s, c); \
	if ((_d != (UINT32)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("shrd(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	BYTE_RCLCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_BYTE_RCLCL(d, s, c); \
	if ((_d != (UINT8)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("rclb(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	WORD_RCLCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_WORD_RCLCL(d, s, c); \
	if ((_d != (UINT16)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("rclw(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	DWORD_RCLCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_DWORD_RCLCL(d, s, c); \
	if ((_d != (UINT32)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("rcld(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	BYTE_RCRCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_BYTE_RCRCL(d, s, c); \
	if ((_d != (UINT8)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("rcrb(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	WORD_RCRCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_WORD_RCRCL(d, s, c); \
	if ((_d != (UINT16)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("rcrw(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	DWORD_RCRCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_DWORD_RCRCL(d, s, c); \
	if ((_d != (UINT32)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("rcrd(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	BYTE_ROLCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_BYTE_ROLCL(d, s, c); \
	if ((_d != (UINT8)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("rolb(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	WORD_ROLCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_WORD_ROLCL(d, s, c); \
	if ((_d != (UINT16)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("rolw(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	DWORD_ROLCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_DWORD_ROLCL(d, s, c); \
	if ((_d != (UINT32)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("rold(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	BYTE_RORCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_BYTE_RORCL(d, s, c); \
	if ((_d != (UINT8)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("rorb(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	WORD_RORCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_WORD_RORCL(d, s, c); \
	if ((_d != (UINT16)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("rorw(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
...
#define	DWORD_RORCL(d, s, c) { \
	...
	__asm {	mov		_f, ah			} \
	_DWORD_RORCL(d, s, c); \
	if ((_d != (UINT32)(d)) || ((_f ^ CPU_FLAGL) & SZPC_FLAG) || ((!_ov) != (!CPU_OV))) TRACEOUT(("rord(%x) r=%x:%x f=%x:%x o=%d %d", c, _d, d, _f, CPU_FLAGL, _ov, CPU_OV)); \
}
