...
const BYTE mstr_ok[] = {			// OK
		0x4f,0x4b,0};
const BYTE mstr_cancel[] = {		// ÉLÉÉÉìÉZÉã
		0xb7,0xac,0xdd,0xbe,0xd9,0};
const BYTE mstr_abort[] = {			// íÜé~
		0x92,0x86,0x8e,0x7e,0x00};
const BYTE mstr_retry[] = {			// çƒééçs
		0x8d,0xc4,0x8e,0x8e,0x8d,0x73,0x00};
const BYTE mstr_ignore[] = {		// ñ≥éã
		0x96,0xb3,0x8e,0x8b,0x00};
const BYTE mstr_yes[] = {			// ÇÕÇ¢
		0x82,0xcd,0x82,0xa2,0x00};
const BYTE mstr_no[] = {			// Ç¢Ç¢Ç¶
