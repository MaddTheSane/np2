...
#if 0
I286_F6 _nop_int(I286CORE *cpu, UINT op)
{
	INT_NUM(6, I286_IP - 2);
}
#endif

I286_F6 _inc_ea8(I286CORE *cpu, UINT op)
{
	UINT32	madr;
	UINT8	*out;
	REG8	res;
...
I286_F6 _dec_ea8(I286CORE *cpu, UINT op)
{
	UINT32	madr;
	UINT8	*out;
	REG8	res;
...
I286_F6 _inc_ea16(I286CORE *cpu, UINT op)
{
	UINT32	madr;
	UINT16	*out;
	REG16	res;
...
I286_F6 _dec_ea16(I286CORE *cpu, UINT op)
{
	UINT32	madr;
	UINT16	*out;
	REG16	res;
...
I286_F6 _call_ea16(I286CORE *cpu, UINT op)
{
	UINT16	src;
...
I286_F6 _call_far_ea16(I286CORE *cpu, UINT op)
{
	UINT32	seg;
	UINT	ad;
...
I286_F6 _jmp_ea16(I286CORE *cpu, UINT op)
{
	if (op >= 0xc0)
	{
		I286_WORKCLOCK(7);
...
I286_F6 _jmp_far_ea16(I286CORE *cpu, UINT op)
{
	UINT32	seg;
	UINT	ad;
...
I286_F6 _push_ea16(I286CORE *cpu, UINT op)
{
	UINT16	src;
...
I286_F6 _pop_ea16(I286CORE *cpu, UINT op)
{
	UINT16	src;
