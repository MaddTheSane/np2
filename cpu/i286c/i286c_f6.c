...
I286_F6 _test_ea8_data8(I286CORE *cpu, UINT op)
{
	UINT	src;
	UINT	dst;
...
I286_F6 _not_ea8(I286CORE *cpu, UINT op)
{
	UINT32	madr;
...
I286_F6 _neg_ea8(I286CORE *cpu, UINT op)
{
	UINT8	*out;
	UINT	src;
	UINT	dst;
...
I286_F6 _mul_ea8(I286CORE *cpu, UINT op)
{
	UINT8	src;
	UINT	res;
...
I286_F6 _imul_ea8(I286CORE *cpu, UINT op)
{
	UINT8	src;
	SINT32	res;
...
I286_F6 _div_ea8(I286CORE *cpu, UINT op)
{
	UINT16	tmp;
	UINT8	src;
	UINT16	ip;
...
I286_F6 _idiv_ea8(I286CORE *cpu, UINT op)
{
	SINT16	tmp, r;
	SINT8	src;
	UINT16	ip;
...
I286_F6 _test_ea16_data16(I286CORE *cpu, UINT op)
{
	UINT32	src;
	UINT32	dst;
...
I286_F6 _not_ea16(I286CORE *cpu, UINT op)
{
	UINT32	madr;
...
I286_F6 _neg_ea16(I286CORE *cpu, UINT op)
{
	UINT16	*out;
	UINT32	src;
	UINT32	dst;
...
I286_F6 _mul_ea16(I286CORE *cpu, UINT op)
{
	UINT16	src;
	UINT32	res;
...
I286_F6 _imul_ea16(I286CORE *cpu, UINT op)
{
	SINT16	src;
	SINT32	res;
...
I286_F6 _div_ea16(I286CORE *cpu, UINT op)
{
	UINT32	tmp;
	UINT32	src;
	UINT16	ip;
...
I286_F6 _idiv_ea16(I286CORE *cpu, UINT op)
{
	SINT32	tmp;
	SINT32	r;
	SINT16	src;
