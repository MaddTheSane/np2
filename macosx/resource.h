...
#define	IDM_ROLNORMAL		MAKE_MENUID(IDM_SCREEN, 1)
#define	IDM_ROLLEFT			MAKE_MENUID(IDM_SCREEN, 2)
#define	IDM_ROLRIGHT		MAKE_MENUID(IDM_SCREEN, 3)
#define	IDM_DISPSYNC		MAKE_MENUID(IDM_SCREEN, 5)
#define	IDM_RASTER			MAKE_MENUID(IDM_SCREEN, 6)
#define	IDM_NOWAIT			MAKE_MENUID(IDM_SCREEN, 7)
#define	IDM_AUTOFPS			MAKE_MENUID(IDM_SCREEN, 8)
#define	IDM_60FPS			MAKE_MENUID(IDM_SCREEN, 9)
#define	IDM_30FPS			MAKE_MENUID(IDM_SCREEN, 10)
#define	IDM_20FPS			MAKE_MENUID(IDM_SCREEN, 11)
#define	IDM_15FPS			MAKE_MENUID(IDM_SCREEN, 12)
#define	IDM_SCREENOPT		MAKE_MENUID(IDM_SCREEN, 14)
