...
enum {
	...
	IDM_F12COMMA		= MAKE_MENUID(IDM_KEYBOARD, 17),
	IDM_F12XFER			= MAKE_MENUID(IDM_KEYBOARD, 18),
    ...
    IDM_RECORDING		= MAKE_MENUID(IDM_OTHER, 9),
	IDM_I286SAVE		= MAKE_MENUID(IDM_OTHER, 10),
